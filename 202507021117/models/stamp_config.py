...
class StampConfig:
    ...
    # Aussehen
    rotation: float = 0  # Rotation in Grad (0, 90, 180, 270)
    
    # Rahmen
    show_border: bool = True
    border_width: float = 2.0
    border_color: str = "#000000"  # Hex-Farbe
    border_radius: float = 0.0  # Eckenradius - Standard 0 für gerade Rahmen
    
    # Hintergrund
    show_background: bool = True
    background_color: str = "#FFFFFF"  # Hex-Farbe
    background_opacity: float = 1.0  # 0.0 - 1.0, Standard 100%
    
    # Schatten
    show_shadow: bool = False  # Standard aus
    ...
    def from_dict(cls, data: dict) -> 'StampConfig':
        ...
        # Kompatibilität: Konvertiere alte orientation zu rotation
        ...
        return cls(
            ...
            border_radius=data.get("border_radius", 0.0),
