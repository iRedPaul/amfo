...
class PDFProcessor:
    ...
    def __init__(self):
        ...
        # GEÄNDERT: Nur noch COMPRESS als Processing Action
    ...
    def process_document(self, doc_pair: DocumentPair, hotfolder: HotfolderConfig) -> bool:
        ...
        try:
            ...
            # GEÄNDERT: Führe nur noch unterstützte PDF-Aktionen aus (nur COMPRESS)
            ...
            # GEÄNDERT: Prüfe ob Stempel angewendet werden
            has_stamps = False
            if hasattr(hotfolder, 'stamp_configs') and hotfolder.stamp_configs:
                ...
                for stamp_dict in hotfolder.stamp_configs:
                    try:
                        ...
                        if stamp_config.enabled:  # Nur aktive Stempel
            ...
            # GEÄNDERT: Führe Exporte durch - übergebe Information über Stempel und Komprimierung
            if hasattr(hotfolder, 'export_configs') and hotfolder.export_configs:
                ...
                export_results = self.export_processor.process_exports(
                    ...
                    original_pdf_path=doc_pair.pdf_path,
                    input_path=hotfolder.input_path,
                    has_stamps=has_stamps,  # GEÄNDERT: Übergebe Stempel-Information
                    compression_enabled=compression_enabled  # GEÄNDERT: Übergebe Komprimierungs-Information
                )
