...
from gui.database_config_dialog import DatabaseConfigDialog  # NEU: Import für Datenbank-Dialog
...
class MainWindow:
    ...
    def __init__(self):
        ...
        # Starte Manager und prüfe ob GUI-Update nötig
        license_deactivated = self.manager.start()
        
        # Aktualisiere GUI wenn Hotfolder deaktiviert wurden
    ...
    def _create_menu(self):
        ...
        extras_menu.add_command(label="Datenbank-Verbindungen...", command=self._manage_databases)  # NEU: Menüpunkt für Datenbanken
        ...
        if new_state:  # Nur beim Aktivieren prüfen
            ...
            if not license_manager.is_licensed():
                messagebox.showerror(
                    ...
                    "Sie können keine Hotfolder aktivieren ohne gültige Lizenz.\n\n"
                    "Bitte installieren Sie eine Lizenz über die Einstellungen."
                )
                return
            
            # Prüfe auf doppelte Input-Pfade
    ...
    def _manage_databases(self):  # NEU: Methode für Datenbank-Verwaltung
        """Öffnet den Dialog für Datenbank-Verbindungen"""
        try:
    ...
    def _show_about(self):
        ...
        messagebox.showinfo(
            ...
            "• ODBC-Datenbankabfragen"  # NEU: Erwähnung der Datenbankfunktion
        )
