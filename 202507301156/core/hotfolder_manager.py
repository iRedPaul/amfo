...
class HotfolderManager:
    ...
    def __init__(self):
        ...
        logger.info("belegpilot initialisiert")
    ...
    def start(self) -> bool:
        ...
        with self._lock:
            if self._running:
                logger.warning("belegpilot läuft bereits")
                return False
            
            logger.info("Starte belegpilot...")
            self._running = True
            ...
            logger.info("belegpilot erfolgreich gestartet")
    ...
    def stop(self):
        ...
        logger.info("Starte Shutdown des belegpilots...")
        
        with self._lock:
            if not self._running:
                logger.warning("belegpilot läuft nicht")
                return
        ...
        logger.info("belegpilot erfolgreich gestoppt")
