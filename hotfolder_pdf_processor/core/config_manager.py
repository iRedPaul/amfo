...
class ConfigManager:
    ...
    def validate_paths(self, hotfolder: HotfolderConfig) -> tuple[bool, str]:
        ...
        # Output-Pfad ist optional, aber falls gesetzt, muss er absolut sein
        if hotfolder.output_path and not os.path.isabs(hotfolder.output_path):
            return False, f"Output-Pfad ist nicht absolut: {hotfolder.output_path}"
