    ...
    def _process_file(self, file_path: str):
        ...
        try:
            ...
            if doc_pair:
                ...
                if success:
                    print(f"Datei erfolgreich verarbeitet: {file_path}")
                else:
                    print(f"Fehler bei der Verarbeitung: {file_path}")
        ...
        if file_path.lower().endswith('.pdf'):
            ...
            if self.config.process_pairs:
                ...
                if os.path.exists(potential_xml):
                    ...
                    print(f"PDF ohne zugehörige XML gefunden (wird ignoriert): {file_path}")
                    return None
            ...
            if os.path.exists(potential_pdf):
                ...
                print(f"XML ohne zugehörige PDF gefunden: {file_path}")
                return None
