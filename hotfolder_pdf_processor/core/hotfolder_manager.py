...
class HotfolderManager:
        ...
        try:
            ...
            if not exports:
                exports = [{
                    ...
                    "enabled": True,
                    "export_type": "file",
                    "output_path_expression": output_path,
                    "filename_expression": output_filename_expression,
    ...
    def update_hotfolder(self, hotfolder_id: str, **kwargs) -> tuple[bool, str]:
        ...
        try:
            ...
            if any(k in kwargs for k in ["input_path", "output_path", "error_path"]):
                valid, message = self.config_manager.validate_paths(hotfolder)
                if not valid:
                    return False, message
