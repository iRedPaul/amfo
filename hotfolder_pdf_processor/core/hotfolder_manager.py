...
class HotfolderManager:
    ...
    def create_hotfolder(self, name: str, input_path: str, output_path: str,
        ...
        try:
            ...
            # Wenn kein Output-Pfad angegeben ist, bleibt output_path leer.
            # Die Logik, dass dann in den Fehlerpfad verschoben wird, muss beim Verarbeiten erfolgen.
            ...
            hotfolder = HotfolderConfig(
                ...
                output_path=output_path,  # Kann leer sein
