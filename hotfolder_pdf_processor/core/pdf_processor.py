        ...
        try:
            ...
            if not hasattr(hotfolder, 'export_configs') or not hotfolder.export_configs:
                if is_split:
                    ...
                    if temp_doc_pair.has_xml and temp_xml_path is not None:
                    ...
                    if temp_doc_pair.has_xml and hotfolder.process_pairs and temp_xml_path is not None:
