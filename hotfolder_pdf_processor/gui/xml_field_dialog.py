...
class FieldMappingEditDialog:
    ...
    def __init__(self, parent, mapping: Optional[FieldMapping] = None, 
        ...
        if mapping and mapping.zones:
            self.ocr_zones = mapping.zones.copy()
        elif mapping and mapping.zone:
    ...
    def _create_widgets(self):
        ...
        self.var_func_tree = ttk.Treeview(self.tree_container, height=15)
