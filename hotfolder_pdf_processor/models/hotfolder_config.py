...
class HotfolderConfig:
    ...
    input_path: str
    output_path: str
    error_path: str = ""  # Neuer Fehler-Ordner
    enabled: bool = True
    ...
    output_filename_expression: str = "<FileName>"  # DEPRECATED - Wird durch exports ersetzt
    ocr_zones: List[OCRZone] = field(default_factory=list)  # OCR-Zonen
    exports: List[Dict[str, Any]] = field(default_factory=list)  # NEU: Export-Konfigurationen
    ...
    def from_dict(cls, data: dict) -> 'HotfolderConfig':
        ...
        # Migration: Wenn exports nicht vorhanden, erstelle Standard-Export aus alten Feldern
        exports = data.get("exports", [])
        if not exports and data.get("output_path"):
            # Erstelle Standard-Dateiexport aus Legacy-Konfiguration
            default_export = {
                "id": "default",
                "name": "Standard-Ausgabe",
                "enabled": True,
                "export_type": "file",
                "output_path_expression": data.get("output_path", ""),
                "filename_expression": data.get("output_filename_expression", "<FileName>"),
                "create_path_if_not_exists": True,
                "append_to_existing_file": False,
                "error_output_path": data.get("error_path", ""),
                "metadata_config": {
                    "format": "none"
                }
            }
        ...
        return cls(
            ...
            error_path=data.get("error_path", ""),  # Rückwärtskompatibilität
